...
const (
	// Обращаемся к Envoy Gateway вместо прямого обращения к weather API
	// Envoy проксирует запросы на соответствующие backend сервисы
	serverURL         = "http://localhost:8080" // Envoy Gateway endpoint
