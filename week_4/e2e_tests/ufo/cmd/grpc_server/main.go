...
import (
	...
	ufoV1API "github.com/olezhek28/microservices-course-examples/week_4/e2e_tests/ufo/internal/api/ufo/v1"
	"github.com/olezhek28/microservices-course-examples/week_4/e2e_tests/ufo/internal/config"
	ufoRepository "github.com/olezhek28/microservices-course-examples/week_4/e2e_tests/ufo/internal/repository/ufo"
	ufoService "github.com/olezhek28/microservices-course-examples/week_4/e2e_tests/ufo/internal/service/ufo"
)
...
func main() {
	...
	repo := ufoRepository.NewRepository(mongoClient, config.AppConfig().Mongo.DatabaseName())
